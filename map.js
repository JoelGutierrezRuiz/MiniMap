...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Capa de base de CartoDB sin etiquetas
  L.tileLayer('https://{s}.basemaps.cartocdn.com/light_nolabels/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, &copy; <a href="https://carto.com/attributions">CartoDB</a>',
    detectRetina: true
  }).addTo(map);

  // Cargar las fronteras de los países en formato GeoJSON
  ...
  map.on("click", async (e) => {
    ...
    alert(getCountryName(city[0].country));
  ...
  function getCountryName(code) {
    const country = countries.find(c => c.code === code); // Busca el objeto con el código
    return country ? country.name : 'Country not found'; // Devuelve el nombre si se encuentra, o un mensaje si no
  }
